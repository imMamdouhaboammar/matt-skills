...
description: Use when creating or editing agent-facing Skills, AGENTS.md or CLAUDE.md instructions, referenced agent documents, context pointers, templates, or other reusable guidance consumed by an agent.
---
