...
description: Use when a decision, spec, or implementation question depends on facts only another stakeholder can provide and those unknowns should be turned into a precise questionnaire.
---
